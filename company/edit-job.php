   ...
   <header>
	...
	<div class="container">
		<div class="row">
			...
			<h2 class="text-center">Update Job Post Details</h2>
			<form method="post" action="editpost.php">
			<?php
			$sql="SELECT * FROM job_post WHERE id_jobpost='$_GET[id]' AND id_company='$_SESSION[id_company]'";// check from the database if the user exists and give a row result	
			...
			?>
			  ...
			  <div class="form-group">
				...
				<textarea type="text" class="form-control" id="description" name="description"  placeholder="Job Description" required=""><?php echo $row['description']; ?></textarea>
			  </div>
			  <div class="form-group">
			  ...
			  <div class="text-center">
			   <button type="submit" class="btn btn-success">Update Job Details</button>
			   </div>
			    <?php
			    }
			}else{
