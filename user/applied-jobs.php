	...
	<div class="row">
		<div class="col-md-12">
			<div class="table-responsive">
					<h2 class="text-center">Jobs Applied</h2>
					<table class="table table-striped">
						...
						<tbody>
							<?php
							$sql="SELECT * FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_job_post WHERE apply_job_post.id_user='$_SESSION[id_user]' ";
